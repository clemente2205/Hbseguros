...
export default function NavBar(props) {
    ...
    const [patas, setPatas] = useState(false)
    const ruta = ({ url = '/' }) => { console.log('navegando a', url) }
            ...
            <div className={General.contenedorPrincipal}>
                ...
                <div className={Principal.formEncabezado}>
                    <div className={Principal.all}>
                        ...
                        <div className={Principal.center} onClick={() => { setPatas(!patas); ruta({ url: 'ejemplo' }) }}>
